...
export default function PageHero({ title, subtitle, breadcrumbs = [], icon: Icon }) {
  return (
    <div className="relative bg-[#12377B] text-white overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div
          className="absolute -right-20 top-0 bottom-0 w-1/3 bg-[#E6AC09]/10"
        ...
        <motion.div
          ...
          className="absolute -top-16 -right-16 w-80 h-80 rounded-full border-2 border-[#E6AC09]/30"
        />
        <div className="absolute top-4 right-10 w-16 h-16 rounded-full bg-[#E6AC09]/15" />
        <div className="absolute bottom-2 left-1/3 w-8 h-8 rounded-full bg-white/10" />

        {/* Barra izquierda naranja gruesa */}
        <div className="absolute left-0 top-0 h-full w-1.5 bg-gradient-to-b from-[#E6AC09] via-[#E6AC09]/70 to-transparent" />
      </div>
      ...
      <div className="relative container mx-auto px-4 md:px-8 py-10 md:py-16">
        ...
        {breadcrumbs.length > 0 && (
          ...
          >
            <Link to="/" className="flex items-center gap-1 hover:text-[#E6AC09] transition-colors">
            ...
            {breadcrumbs.map((crumb, idx) => (
              <React.Fragment key={idx}>
                ...
                {crumb.to && idx < breadcrumbs.length - 1 ? (
                  <Link to={crumb.to} className="hover:text-[#E6AC09] transition-colors">{crumb.label}</Link>
                ) : (
        ...
        <div className="flex items-center gap-6">
          ...
          {Icon && (
            ...
            >
              <Icon className="w-10 h-10 text-[#E6AC09]" />
            </motion.div>
          )}
          ...
          <div className="flex-1">
            ...
            <motion.div
              ...
              className="w-16 h-[3px] bg-[#E6AC09] rounded-full mb-4 origin-left"
            />
